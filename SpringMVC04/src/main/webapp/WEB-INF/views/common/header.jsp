...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <c:if test="${empty mvo}">  <!-- 로그인 하지 않았을때  -->
	      ...
	      <ul class="nav navbar-nav navbar-right">
           ...
           <c:if test="${!empty mvo}">  <!-- 로그인함   -->
		      ...
		      <ul class="nav navbar-nav navbar-right">
				...
				<c:if test= "${!empty mvo}">
					<c:if test= "${empty mvo.memProfile}">   <!--  기본이미지   -->
						<li><img class="img-circle" src= "${contextPath}/resources/images/person.png" style = "width: 50px; height: 50px" /> ${mvo.memName}님 환영합니다.</li>
					</c:if>
				
					<c:if test= "${!empty mvo.memProfile}">   <!--  설정 이미지   -->
						<li><img class="img-circle" src= "${contextPath}/resources/upload/${mvo.memProfile}" style = "width: 50px; height: 50px" /> ${mvo.memName}님 환영합니다.</li>
					</c:if>
