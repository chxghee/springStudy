    	...
    	<!-- memID 히든으로 memID에 값을 저장  -->
    		...
    		<table class = "table table-bordered" style= "text-align: center; border: 1px solid #dddddd;">
    			...
    			<tr>
    				...
    				<td colspan="2"><input id= "memEmail" name= "memEmail" class= "form-control" type = "text" maxlength= "20" placeholder= "email를 입력하세요..." value = "${mvo.member.memEmail}"/></td>
    			...
    			<tr>
    				...
    				<td style= "width: 110px; vartical-align; ">사용자 권환</td>
    				<td colspan="2">    
    						<!--  현재 자신의 권한으로 체크해놓기   -->
