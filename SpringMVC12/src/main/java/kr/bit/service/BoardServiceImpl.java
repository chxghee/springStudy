...
public class BoardServiceImpl implements BoardService {
	...
	public List<Board> getList(Criteria cri) {
		...
		List<Board> list = boardMapper.getList(cri);	// 게시물 리스트 가져오기 
	...
	public Board get(int idx) {
		...
		Board mvo = boardMapper.read(idx);		// 게시판 글 정보 가져오기
		boardMapper.countUpdate(idx);			// 게시판 조회수 증가 
		return mvo;
	}
